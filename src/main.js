...
const foodDB = [
  ...
  { name: "Haşlanmış Yumurta", ref: 1, unit: "adet", cal: 80, p: 6, c: 0.5, f: 6 },
  { name: "Beyaz Peynir", ref: 30, unit: "g", cal: 85, p: 4.5, c: 1, f: 7 },
  { name: "Kaşar Peyniri", ref: 30, unit: "g", cal: 106, p: 8, c: 0.5, f: 8 },
  { name: "Lor Peyniri", ref: 50, unit: "g", cal: 47, p: 8, c: 1.5, f: 1 },
  { name: "Dana Sucuk", ref: 50, unit: "g", cal: 167, p: 7, c: 1, f: 15 },
  { name: "Pastırma", ref: 30, unit: "g", cal: 81, p: 9, c: 0, f: 5 },
  { name: "Sosis", ref: 50, unit: "g", cal: 140, p: 6, c: 2, f: 12 },
  { name: "Simit", ref: 1, unit: "adet", cal: 272, p: 9, c: 50, f: 4 },
  ...
  { name: "Bal", ref: 1, unit: "tatlı kaşığı", cal: 32, p: 0, c: 8, f: 0 },
  { name: "Yulaf Ezmesi", ref: 50, unit: "g", cal: 187, p: 7, c: 33, f: 3 },
  
  // --- Kullanıcı Güncellemesi: Part 2 (Çorbalar) ---
  { name: "Mercimek Çorbası", ref: 1, unit: "kase", cal: 136, p: 7, c: 18, f: 4 },
  { name: "Ezogelin Çorbası", ref: 1, unit: "kase", cal: 148, p: 6, c: 22, f: 4 },
  { name: "Tarhana Çorbası", ref: 1, unit: "kase", cal: 121, p: 4, c: 15, f: 5 },
  { name: "Yayla Çorbası", ref: 1, unit: "kase", cal: 100, p: 4, c: 12, f: 4 },
  { name: "Tavuk Suyu Çorbası", ref: 1, unit: "kase", cal: 108, p: 8, c: 10, f: 4 },
  { name: "İşkembe Çorbası", ref: 1, unit: "kase", cal: 158, p: 12, c: 5, f: 10 },
  { name: "Kelle Paça Çorbası", ref: 1, unit: "kase", cal: 249, p: 20, c: 4, f: 17 },
  { name: "Domates Çorbası", ref: 1, unit: "kase", cal: 92, p: 2, c: 12, f: 4 },
  { name: "Ayran Aşı Çorbası", ref: 1, unit: "kase", cal: 107, p: 5, c: 15, f: 3 },
  { name: "Brokoli Çorbası", ref: 1, unit: "kase", cal: 84, p: 3, c: 9, f: 4 },

  // --- Kullanıcı Güncellemesi: Part 3 (Etler ve Ana Yemekler) ---
  { name: "Izgara Tavuk Göğsü", ref: 150, unit: "g", cal: 167, p: 35, c: 0, f: 3 },
  { name: "Fırın Tavuk But", ref: 1, unit: "adet", cal: 211, p: 18, c: 1, f: 15 },
  { name: "Tavuk Şiş", ref: 1, unit: "porsiyon", cal: 218, p: 30, c: 2, f: 10 },
  { name: "Tavuk Sote", ref: 1, unit: "porsiyon", cal: 239, p: 25, c: 10, f: 11 },
  { name: "Izgara Köfte", ref: 150, unit: "g", cal: 296, p: 25, c: 4, f: 20 },
  { name: "Sulu Köfte", ref: 1, unit: "porsiyon", cal: 258, p: 15, c: 18, f: 14 },
  { name: "Adana Kebap", ref: 1, unit: "porsiyon", cal: 363, p: 25, c: 5, f: 27 },
  { name: "İskender Kebap", ref: 1, unit: "porsiyon", cal: 747, p: 35, c: 55, f: 43 },
  { name: "Et Döner", ref: 100, unit: "g", cal: 284, p: 24, c: 2, f: 20 },
  { name: "Tavuk Döner", ref: 100, unit: "g", cal: 190, p: 22, c: 3, f: 10 },
  { name: "Tas Kebabı", ref: 1, unit: "porsiyon", cal: 316, p: 22, c: 12, f: 20 },
  { name: "Karnıyarık", ref: 1, unit: "adet", cal: 270, p: 12, c: 15, f: 18 },
  { name: "Hünkar Beğendi", ref: 1, unit: "porsiyon", cal: 422, p: 20, c: 18, f: 30 },
  { name: "Etli Yaprak Sarma", ref: 6, unit: "adet", cal: 222, p: 8, c: 25, f: 10 },
  { name: "Etli Biber Dolması", ref: 1, unit: "adet", cal: 153, p: 6, c: 12, f: 9 },
  { name: "Fırın Somon", ref: 150, unit: "g", cal: 309, p: 30, c: 0, f: 21 },
  { name: "Izgara Levrek", ref: 200, unit: "g", cal: 241, p: 40, c: 0, f: 9 },
  { name: "Ton Balığı (Yağsız Konserve)", ref: 100, unit: "g", cal: 109, p: 25, c: 0, f: 1 },

  // --- Kullanıcı Güncellemesi: Part 4 (Zeytinyağlılar & Sebzeler) ---
  { name: "Etli Kuru Fasulye", ref: 1, unit: "porsiyon", cal: 283, p: 16, c: 30, f: 11 },
  { name: "Etsiz Kuru Fasulye", ref: 1, unit: "porsiyon", cal: 224, p: 12, c: 35, f: 4 },
  { name: "Etli Nohut Yemeği", ref: 1, unit: "porsiyon", cal: 287, p: 15, c: 32, f: 11 },
  { name: "Yeşil Mercimek Yemeği", ref: 1, unit: "porsiyon", cal: 212, p: 14, c: 30, f: 4 },
  { name: "Zeytinyağlı Barbunya", ref: 1, unit: "porsiyon", cal: 243, p: 8, c: 28, f: 11 },
  { name: "Zeytinyağlı Taze Fasulye", ref: 1, unit: "porsiyon", cal: 132, p: 3, c: 12, f: 8 },
  { name: "Zeytinyağlı Yaprak Sarma", ref: 6, unit: "adet", cal: 202, p: 3, c: 25, f: 10 },
  { name: "İmam Bayıldı", ref: 1, unit: "adet", cal: 189, p: 3, c: 15, f: 13 },
  { name: "Şakşuka", ref: 1, unit: "porsiyon", cal: 176, p: 3, c: 14, f: 12 },
  { name: "Ispanak Yemeği (Yumurtasız)", ref: 1, unit: "porsiyon", cal: 102, p: 4, c: 8, f: 6 },
  { name: "Mücver", ref: 2, unit: "adet", cal: 238, p: 8, c: 20, f: 14 },
  { name: "Türlü Yemeği", ref: 1, unit: "porsiyon", cal: 130, p: 4, c: 15, f: 6 },

  // --- Kullanıcı Güncellemesi: Part 5 (Karbonhidratlar & Ekmekler) ---
  { name: "Pirinç Pilavı", ref: 1, unit: "porsiyon", cal: 259, p: 4, c: 45, f: 7 },
  { name: "Bulgur Pilavı", ref: 1, unit: "porsiyon", cal: 220, p: 6, c: 40, f: 4 },
  { name: "Sade Makarna", ref: 1, unit: "porsiyon", cal: 242, p: 8, c: 48, f: 2 },
  { name: "Patates Püresi", ref: 1, unit: "porsiyon", cal: 181, p: 3, c: 22, f: 9 },
  { name: "Haşlanmış Patates (Orta Boy)", ref: 1, unit: "adet", cal: 108, p: 2, c: 25, f: 0 },
  { name: "Lavaş", ref: 1, unit: "adet", cal: 178, p: 5, c: 35, f: 2 },
  { name: "Beyaz Ekmek (Normal / Somun)", ref: 1, unit: "dilim", cal: 71, p: 2, c: 14, f: 0.8 },
  { name: "Beyaz Ekmek (100g)", ref: 100, unit: "g", cal: 273, p: 8, c: 53, f: 3.2 },
  { name: "Somun Ekmek", ref: 1, unit: "dilim", cal: 69, p: 2, c: 13, f: 1 },
  { name: "Tam Buğday Ekmek", ref: 1, unit: "dilim", cal: 63, p: 2.5, c: 11, f: 1 },
  { name: "Kepekli Ekmek", ref: 1, unit: "dilim", cal: 63, p: 2.2, c: 12, f: 0.7 },
  { name: "Çavdar Ekmeği", ref: 1, unit: "dilim", cal: 68, p: 2.1, c: 13, f: 0.8 },
  { name: "Yulaf Ekmeği", ref: 1, unit: "dilim", cal: 67, p: 2.5, c: 12, f: 1 },
  { name: "Ekşi Mayalı Ekmek", ref: 1, unit: "dilim", cal: 83, p: 3, c: 16, f: 0.8 },
  { name: "Mısır Ekmeği", ref: 50, unit: "g", cal: 148, p: 3, c: 25, f: 4 },
  { name: "Tost Ekmeği (Beyaz)", ref: 1, unit: "dilim", cal: 74, p: 2.2, c: 14, f: 1 },
  { name: "Tost Ekmeği (Kepekli)", ref: 1, unit: "dilim", cal: 69, p: 2.4, c: 13, f: 0.8 },
  { name: "Sandviç Ekmeği", ref: 1, unit: "adet", cal: 182, p: 6, c: 35, f: 2 },
  { name: "Hamburger Ekmeği", ref: 1, unit: "adet", cal: 163, p: 5, c: 30, f: 2.5 },
  { name: "Ramazan Pidesi", ref: 1, unit: "dilim", cal: 134, p: 4, c: 25, f: 2 },

  // --- Kullanıcı Güncellemesi: Part 6 (Sokak Lezzetleri & Fast Food) ---
  { name: "Lahmacun", ref: 1, unit: "adet", cal: 223, p: 10, c: 30, f: 7 },
  { name: "Kıymalı Pide", ref: 1, unit: "porsiyon", cal: 454, p: 18, c: 55, f: 18 },
  { name: "Kaşarlı Pide", ref: 1, unit: "porsiyon", cal: 502, p: 20, c: 65, f: 18 },
  { name: "Kokoreç (Yarım Ekmek)", ref: 1, unit: "adet", cal: 649, p: 28, c: 60, f: 33 },
  { name: "Tantuni (Lavaş)", ref: 1, unit: "adet", cal: 346, p: 20, c: 35, f: 14 },
  { name: "Midye Dolma", ref: 10, unit: "adet", cal: 254, p: 6, c: 35, f: 10 },
  { name: "Çiğ Köfte (Lavaş Dürüm)", ref: 1, unit: "adet", cal: 342, p: 8, c: 55, f: 10 },
  { name: "Islak Hamburger", ref: 1, unit: "adet", cal: 323, p: 12, c: 35, f: 15 },
  { name: "Kumpir (Karışık)", ref: 1, unit: "adet", cal: 749, p: 15, c: 80, f: 41 },
  { name: "Sokak Tavuklu Pilav (Nohutlu)", ref: 1, unit: "porsiyon", cal: 424, p: 20, c: 50, f: 16 },
  { name: "Sucuk Ekmek (Yarım)", ref: 1, unit: "adet", cal: 553, p: 22, c: 60, f: 25 },
  { name: "Gözleme (Peynirli)", ref: 1, unit: "adet", cal: 399, p: 12, c: 45, f: 19 },

  // --- Kullanıcı Güncellemesi: Part 7 (Salata & Mezeler) ---
  { name: "Çoban Salata (Yağlı)", ref: 1, unit: "porsiyon", cal: 94, p: 2, c: 8, f: 6 },
  { name: "Gavurdağı Salatası", ref: 1, unit: "porsiyon", cal: 151, p: 3, c: 10, f: 11 },
  { name: "Haydari", ref: 1, unit: "porsiyon", cal: 121, p: 4, c: 6, f: 9 },
  { name: "Humus", ref: 1, unit: "porsiyon", cal: 156, p: 6, c: 15, f: 8 },
  { name: "Acılı Ezme", ref: 1, unit: "porsiyon", cal: 58, p: 2, c: 8, f: 2 },
  { name: "Fava", ref: 1, unit: "porsiyon", cal: 184, p: 8, c: 20, f: 8 },
  { name: "Havuç Tarator", ref: 1, unit: "porsiyon", cal: 143, p: 3, c: 8, f: 11 },
  { name: "Kısır", ref: 1, unit: "porsiyon", cal: 223, p: 5, c: 35, f: 7 },
  { name: "Mercimek Köftesi", ref: 4, unit: "adet", cal: 178, p: 6, c: 25, f: 6 },

  // --- Kullanıcı Güncellemesi: Part 8 (Tatlılar & Çerezler) ---
  { name: "Baklava", ref: 2, unit: "dilim", cal: 336, p: 3, c: 45, f: 16 },
  { name: "Sütlaç", ref: 1, unit: "kase", cal: 258, p: 6, c: 45, f: 6 },
  { name: "Künefe", ref: 1, unit: "porsiyon", cal: 448, p: 8, c: 50, f: 24 },
  { name: "Profiterol", ref: 1, unit: "kase", cal: 382, p: 6, c: 40, f: 22 },
  { name: "Aşure", ref: 1, unit: "kase", cal: 342, p: 7, c: 65, f: 6 },
  { name: "Güllaç", ref: 1, unit: "dilim", cal: 254, p: 6, c: 35, f: 10 },
  { name: "Trileçe", ref: 1, unit: "dilim", cal: 296, p: 7, c: 40, f: 12 },
  { name: "Kuruyemiş Karışımı", ref: 30, unit: "g", cal: 178, p: 5, c: 8, f: 14 },
  { name: "Çiğ Badem", ref: 30, unit: "g", cal: 174, p: 6, c: 6, f: 14 },
  { name: "Ayran", ref: 1, unit: "bardak", cal: 76, p: 4, c: 6, f: 4 },
  { name: "Kefir", ref: 1, unit: "bardak", cal: 101, p: 6, c: 8, f: 5 },

  // --- Kullanıcı Güncellemesi: İçecek 1 (Kahveler) ---
  { name: "Filtre Kahve", ref: 250, unit: "ml", cal: 6, p: 0.5, c: 1, f: 0 },
  ...
  { name: "Cortado", ref: 1, unit: "fincan", cal: 51, p: 3, c: 4, f: 2.5 },
  { name: "Sütlü Filtre Kahve", ref: 250, unit: "ml", cal: 29, p: 2, c: 3, f: 1 },
  ...
  { name: "Latte (Yağsız)", ref: 350, unit: "ml", cal: 89, p: 8, c: 13, f: 0.6 },
  { name: "Latte (Badem Sütü)", ref: 350, unit: "ml", cal: 80, p: 3, c: 5, f: 5.3 },
  { name: "Latte (Yulaf Sütü)", ref: 350, unit: "ml", cal: 120, p: 3, c: 18, f: 4 },
  { name: "Latte (Soya Sütü)", ref: 350, unit: "ml", cal: 109, p: 7, c: 10, f: 4.6 },
  { name: "Flat White", ref: 250, unit: "ml", cal: 129, p: 7, c: 10, f: 6.8 },
  ...
  { name: "Karamel Macchiato (Yağsız)", ref: 350, unit: "ml", cal: 181, p: 8, c: 35, f: 1 },
  ...
  { name: "Irish Nut Latte", ref: 350, unit: "ml", cal: 229, p: 8, c: 30, f: 8.6 },
  ...
  { name: "Gingerbread Latte", ref: 350, unit: "ml", cal: 239, p: 8, c: 32, f: 8.8 },
  { name: "Türk Kahvesi (Sade)", ref: 1, unit: "fincan", cal: 6, p: 0.5, c: 1, f: 0 },
  { name: "Türk Kahvesi (Orta)", ref: 1, unit: "fincan", cal: 20, p: 0.5, c: 4.5, f: 0 },
  { name: "Türk Kahvesi (Şekerli)", ref: 1, unit: "fincan", cal: 34, p: 0.5, c: 8, f: 0 },
  { name: "Sütlü Türk Kahvesi", ref: 1, unit: "fincan", cal: 40, p: 2, c: 4, f: 1.8 },
  { name: "Dibek Kahvesi", ref: 1, unit: "fincan", cal: 54, p: 1, c: 8, f: 2 },
  { name: "Menengiç Kahvesi", ref: 1, unit: "fincan", cal: 69, p: 2, c: 5, f: 4.6 },
  { name: "Çörek Otu Kahvesi", ref: 1, unit: "fincan", cal: 44, p: 1, c: 6, f: 1.8 },
  { name: "Keçiboynuzu Kahvesi", ref: 1, unit: "fincan", cal: 36, p: 0.5, c: 8, f: 0.2 },
  { name: "Mırra", ref: 1, unit: "fincan", cal: 6, p: 0.5, c: 1, f: 0 },

  // --- Meyveler ---
  { name: "Muz", ref: 100, unit: "g", cal: 96, p: 1, c: 23, f: 0 },
  { name: "Elma (Kırmızı)", ref: 100, unit: "g", cal: 56, p: 0.3, c: 14, f: 0.2 },
  { name: "Yeşil Elma (Ekşi)", ref: 100, unit: "g", cal: 52, p: 0.3, c: 13, f: 0.2 },
  { name: "Portakal", ref: 100, unit: "g", cal: 52, p: 1, c: 12, f: 0 },
  { name: "Mandalina", ref: 100, unit: "g", cal: 53, p: 0.8, c: 12, f: 0.2 },
  { name: "Limon", ref: 100, unit: "g", cal: 29, p: 1, c: 9, f: 0.3 },
  { name: "Greyfurt", ref: 100, unit: "g", cal: 40, p: 0.8, c: 9, f: 0.1 },
  { name: "Çilek", ref: 100, unit: "g", cal: 36, p: 1, c: 8, f: 0 },
  { name: "Üzüm", ref: 100, unit: "g", cal: 76, p: 1, c: 18, f: 0 },
  { name: "Armut", ref: 100, unit: "g", cal: 58, p: 0.3, c: 14, f: 0.1 },
  { name: "Kavun", ref: 100, unit: "g", cal: 35, p: 0.5, c: 8, f: 0.1 },
  { name: "Karpuz", ref: 100, unit: "g", cal: 36, p: 0.6, c: 8, f: 0.2 },
  { name: "Şeftali", ref: 100, unit: "g", cal: 41, p: 0.9, c: 9, f: 0.2 },
  { name: "Kayısı", ref: 100, unit: "g", cal: 47, p: 1.4, c: 10, f: 0.2 },
  { name: "Kiraz", ref: 100, unit: "g", cal: 50, p: 1, c: 11, f: 0.2 },
  { name: "Vişne", ref: 100, unit: "g", cal: 50, p: 1, c: 11, f: 0.2 },
  { name: "Erik (Yeşil / Can)", ref: 100, unit: "g", cal: 44, p: 0.6, c: 10, f: 0.2 },
  { name: "Nar", ref: 100, unit: "g", cal: 90, p: 1.7, c: 18, f: 1.2 },
  { name: "İncir (Taze)", ref: 100, unit: "g", cal: 74, p: 0.8, c: 17, f: 0.3 },
  { name: "Ayva", ref: 100, unit: "g", cal: 58, p: 0.3, c: 14, f: 0.1 },
  { name: "Kivi", ref: 100, unit: "g", cal: 61, p: 1.1, c: 13, f: 0.5 },
  { name: "Ananas", ref: 100, unit: "g", cal: 51, p: 0.5, c: 12, f: 0.1 },
  { name: "Avokado", ref: 100, unit: "g", cal: 161, p: 2, c: 8, f: 13.5 },
  { name: "Böğürtlen", ref: 100, unit: "g", cal: 42, p: 1.4, c: 8, f: 0.5 },
  { name: "Yaban Mersini", ref: 100, unit: "g", cal: 57, p: 0.7, c: 13, f: 0.3 },

  // --- Kullanıcı Güncellemesi: İçecek 2 (Soğuk Kahveler) ---
  { name: "Iced Americano", ref: 1, unit: "bardak", cal: 10, p: 1, c: 1.5, f: 0 },
  { name: "Iced Filter Coffee", ref: 1, unit: "bardak", cal: 6, p: 0.5, c: 1, f: 0 },
  { name: "Iced Ristretto", ref: 1, unit: "shot", cal: 2, p: 0.1, c: 0.4, f: 0 },
  { name: "Iced Lungo", ref: 1, unit: "shot", cal: 5, p: 0.4, c: 0.8, f: 0 },
  { name: "Cold Brew", ref: 1, unit: "bardak", cal: 6, p: 0.5, c: 1, f: 0 },
  { name: "Nitro Cold Brew", ref: 1, unit: "bardak", cal: 6, p: 0.5, c: 1, f: 0 },
  ...
  { name: "Iced Flat White", ref: 1, unit: "bardak", cal: 119, p: 6, c: 9, f: 6.6 },
  { name: "Iced Cortado", ref: 1, unit: "bardak", cal: 45, p: 2.5, c: 3.5, f: 2.3 },
  { name: "Iced Macchiato", ref: 1, unit: "bardak", cal: 19, p: 1, c: 2, f: 0.8 },
  { name: "Iced Caramel Macchiato", ref: 1, unit: "bardak", cal: 220, p: 7, c: 31, f: 7.5 },
  { name: "Iced Mocha", ref: 1, unit: "bardak", cal: 259, p: 9, c: 32, f: 10.6 },
  ...
  { name: "Iced Toffee Nut Latte", ref: 1, unit: "bardak", cal: 219, p: 7, c: 28, f: 8.8 },
  { name: "Iced Irish Nut Latte", ref: 1, unit: "bardak", cal: 210, p: 7, c: 27, f: 8.2 },
  { name: "Iced Pumpkin Spice Latte", ref: 1, unit: "bardak", cal: 229, p: 8, c: 32, f: 7.7 },
  ...
  { name: "Ihlamur", ref: 1, unit: "bardak", cal: 4, p: 0, c: 1, f: 0 },
  { name: "Ihlamur (Ballı)", ref: 1, unit: "bardak", cal: 34, p: 0, c: 8.5, f: 0 },
  { name: "Kuşburnu Çayı", ref: 1, unit: "bardak", cal: 4, p: 0, c: 1, f: 0 },
  { name: "Papatya Çayı", ref: 1, unit: "bardak", cal: 2, p: 0, c: 0.5, f: 0 },
  { name: "Kış Çayı", ref: 1, unit: "bardak", cal: 4, p: 0.1, c: 1, f: 0 },
  { name: "Elma Çayı (Toz/Şekerli)", ref: 1, unit: "bardak", cal: 59, p: 0.2, c: 14.5, f: 0 },
  { name: "Nane Limon", ref: 1, unit: "bardak", cal: 9, p: 0.2, c: 2, f: 0 },
  { name: "Zencefil Çayı", ref: 1, unit: "bardak", cal: 4, p: 0.1, c: 1, f: 0 },
  ...
  { name: "Matcha Latte", ref: 1, unit: "bardak", cal: 179, p: 7, c: 18, f: 8.8 },
  ...
  { name: "Süt (Tam Yağlı - 100ml)", ref: 100, unit: "ml", cal: 62, p: 3.3, c: 4.7, f: 3.3 },
  { name: "Süt (Tam Yağlı)", ref: 1, unit: "bardak", cal: 119, p: 6, c: 9, f: 6.6 },
  { name: "Süt (Yarım Yağlı - 100ml)", ref: 100, unit: "ml", cal: 46, p: 3.3, c: 4.7, f: 1.5 },
  { name: "Süt (Yarım Yağlı)", ref: 1, unit: "bardak", cal: 90, p: 6, c: 9, f: 3.3 },
  { name: "Süt (Yağsız - 100ml)", ref: 100, unit: "ml", cal: 34, p: 3.3, c: 4.7, f: 0.2 },
  { name: "Süt (Yağsız)", ref: 1, unit: "bardak", cal: 69, p: 6, c: 10, f: 0.6 },
  { name: "Laktozsuz Süt (100ml)", ref: 100, unit: "ml", cal: 46, p: 3.3, c: 4.7, f: 1.5 },
  { name: "Laktozsuz Süt", ref: 1, unit: "bardak", cal: 100, p: 6, c: 9, f: 4.4 },
  { name: "Ballı Süt", ref: 1, unit: "bardak", cal: 149, p: 6, c: 16, f: 6.8 },
  { name: "Badem Sütü (Sade - 100ml)", ref: 100, unit: "ml", cal: 14, p: 0.5, c: 0.2, f: 1.2 },
  { name: "Sıcak Badem Sütü", ref: 1, unit: "bardak", cal: 39, p: 1, c: 3, f: 2.6 },
  { name: "Yulaf Sütü (Sade - 100ml)", ref: 100, unit: "ml", cal: 46, p: 1, c: 7, f: 1.5 },
  { name: "Sıcak Yulaf Sütü", ref: 1, unit: "bardak", cal: 100, p: 2, c: 16, f: 3.1 },
  { name: "Soya Sütü (Sade - 100ml)", ref: 100, unit: "ml", cal: 39, p: 3.3, c: 2.5, f: 1.8 },
  { name: "Sıcak Soya Sütü", ref: 1, unit: "bardak", cal: 89, p: 6, c: 8, f: 3.7 },
  { name: "Hindistan Cevizi Sütü (İçmelik - 100ml)", ref: 100, unit: "ml", cal: 20, p: 0.2, c: 2.5, f: 1 },
  { name: "Keçi Sütü (100ml)", ref: 100, unit: "ml", cal: 69, p: 3.6, c: 4.5, f: 4.1 },
  { name: "Manda Sütü (100ml)", ref: 100, unit: "ml", cal: 98, p: 3.8, c: 5.2, f: 6.9 },
  { name: "Çikolatalı Süt (100ml)", ref: 100, unit: "ml", cal: 77, p: 3, c: 11, f: 2.3 },
  { name: "Çikolatalı Süt (Kutu)", ref: 1, unit: "kutu", cal: 160, p: 6, c: 20, f: 6.2 },
  { name: "Çilekli Süt (100ml)", ref: 100, unit: "ml", cal: 72, p: 3, c: 10, f: 2.2 },
  { name: "Çilekli Süt (Kutu)", ref: 1, unit: "kutu", cal: 150, p: 6, c: 20, f: 5.1 },
  { name: "Muzlu Süt (100ml)", ref: 100, unit: "ml", cal: 72, p: 3, c: 10, f: 2.2 },
  { name: "Muzlu Süt (Kutu)", ref: 1, unit: "kutu", cal: 150, p: 6, c: 20, f: 5.1 },
  { name: "Kefir (Sade)", ref: 1, unit: "bardak", cal: 99, p: 6, c: 8, f: 4.8 },
  { name: "Kefir (Meyveli)", ref: 1, unit: "bardak", cal: 139, p: 6, c: 16, f: 5.7 },
  { name: "Ayran (Tam Yağlı)", ref: 1, unit: "bardak", cal: 74, p: 4, c: 6, f: 3.8 },
  { name: "Ayran (Yarım Yağlı)", ref: 1, unit: "bardak", cal: 50, p: 4, c: 6, f: 1.1 },
  { name: "Naneli Ayran", ref: 1, unit: "bardak", cal: 74, p: 4, c: 6, f: 3.8 },
  ...
  { name: "Coca-Cola Zero / Şekersiz", ref: 1, unit: "kutu", cal: 0, p: 0, c: 0, f: 0 },
  { name: "Coca-Cola Light", ref: 1, unit: "kutu", cal: 0, p: 0, c: 0, f: 0 },
  { name: "Pepsi (Klasik)", ref: 1, unit: "kutu", cal: 140, p: 0, c: 35, f: 0 },
  { name: "Pepsi Max", ref: 1, unit: "kutu", cal: 0, p: 0, c: 0, f: 0 },
  ...
  { name: "Yedigün", ref: 1, unit: "kutu", cal: 144, p: 0, c: 36, f: 0 },
  { name: "Schweppes (Tonik)", ref: 1, unit: "kutu", cal: 120, p: 0, c: 30, f: 0 },
  { name: "Schweppes (Mandalina)", ref: 1, unit: "kutu", cal: 134, p: 0, c: 33.5, f: 0 },
  { name: "Schweppes (Limon)", ref: 1, unit: "kutu", cal: 140, p: 0, c: 35, f: 0 },
  { name: "Fruko Gazoz", ref: 1, unit: "kutu", cal: 130, p: 0, c: 32.5, f: 0 },
  { name: "Uludağ Gazoz", ref: 1, unit: "kutu", cal: 124, p: 0, c: 31, f: 0 },
  { name: "Niğde Gazozu", ref: 1, unit: "şişe", cal: 140, p: 0, c: 35, f: 0 },
  { name: "Şeftalili Gazoz", ref: 1, unit: "şişe", cal: 144, p: 0, c: 36, f: 0 },
  { name: "Çilekli Gazoz", ref: 1, unit: "şişe", cal: 144, p: 0, c: 36, f: 0 },
  ...
  { name: "Burn (250ml)", ref: 1, unit: "kutu", cal: 114, p: 0, c: 28.5, f: 0 },
  { name: "Lipton Ice Tea (Şeftali - 100ml)", ref: 100, unit: "ml", cal: 28, p: 0, c: 7, f: 0 },
  { name: "Lipton Ice Tea (Şeftali)", ref: 1, unit: "kutu", cal: 95, p: 0, c: 23.5, f: 0.1 },
  { name: "Lipton Ice Tea (Limon - 100ml)", ref: 100, unit: "ml", cal: 28, p: 0, c: 7, f: 0 },
  { name: "Lipton Ice Tea (Limon)", ref: 1, unit: "kutu", cal: 90, p: 0, c: 22.5, f: 0 },
  { name: "Lipton Ice Tea (Mango / Ananas)", ref: 1, unit: "kutu", cal: 96, p: 0, c: 24, f: 0 },
  { name: "Lipton Yeşil Çay Ice Tea (Limonlu)", ref: 1, unit: "kutu", cal: 92, p: 0, c: 23, f: 0 },
  { name: "Lipton Yeşil Çay Ice Tea (Şeftalili)", ref: 1, unit: "kutu", cal: 92, p: 0, c: 23, f: 0 },
  { name: "Fuse Tea (Şeftali - 100ml)", ref: 100, unit: "ml", cal: 30, p: 0, c: 7.5, f: 0 },
  { name: "Fuse Tea (Şeftali)", ref: 1, unit: "kutu", cal: 100, p: 0, c: 25, f: 0 },
  { name: "Fuse Tea (Limon - 100ml)", ref: 100, unit: "ml", cal: 30, p: 0, c: 7.5, f: 0 },
  { name: "Fuse Tea (Limon)", ref: 1, unit: "kutu", cal: 99, p: 0, c: 24.8, f: 0 },
  { name: "Fuse Tea (Mango & Hindistan Cevizi)", ref: 1, unit: "kutu", cal: 99, p: 0, c: 24.8, f: 0 },
  { name: "Fuse Tea (Karpuz)", ref: 1, unit: "kutu", cal: 99, p: 0, c: 24.8, f: 0 },
  { name: "Didi Şeftali (330ml Kutu)", ref: 1, unit: "kutu", cal: 102, p: 0, c: 25.4, f: 0 },
  { name: "Didi Limon (330ml Kutu)", ref: 1, unit: "kutu", cal: 102, p: 0, c: 25.4, f: 0 },
  { name: "Didi Bergamot (330ml Kutu)", ref: 1, unit: "kutu", cal: 102, p: 0, c: 25.4, f: 0 },
  { name: "Didi Şeftali (500ml Kutu)", ref: 1, unit: "kutu", cal: 155, p: 0, c: 38.8, f: 0 },
  { name: "Didi Limon (500ml Kutu)", ref: 1, unit: "kutu", cal: 155, p: 0, c: 38.8, f: 0 },
  ...
  { name: "Naneli Limonata", ref: 1, unit: "bardak", cal: 104, p: 0.2, c: 25, f: 0.3 },
  ...
  { name: "Şampanya", ref: 1, unit: "kadeh", cal: 13, p: 0.2, c: 3, f: 0 },
  ...
  { name: "Tequila Sunrise", ref: 1, unit: "bardak", cal: 82, p: 0.5, c: 20, f: 0 },
  ...
  { name: "Çıtır Mantı (Kızartma)", ref: 1, unit: "porsiyon", cal: 537, p: 14, c: 46, f: 33 },
  { name: "Pelmeni (Rus Mantısı)", ref: 1, unit: "porsiyon", cal: 376, p: 16, c: 42, f: 16 },
  { name: "Yağ Mantısı", ref: 1, unit: "porsiyon", cal: 445, p: 15, c: 40, f: 25 },
  ...
  { name: "Boşnak Böreği (Peynirli)", ref: 1, unit: "porsiyon", cal: 388, p: 12, c: 40, f: 20 },
  ...
  { name: "Kol Böreği (Peynirli)", ref: 1, unit: "porsiyon", cal: 390, p: 12, c: 45, f: 18 },
  { name: "Tepsi Böreği (Kıymalı)", ref: 1, unit: "porsiyon", cal: 396, p: 14, c: 40, f: 20 },
  { name: "Tepsi Böreği (Ispanaklı)", ref: 1, unit: "porsiyon", cal: 344, p: 10, c: 40, f: 16 },
  { name: "Tepsi Böreği (Patatesli)", ref: 1, unit: "porsiyon", cal: 368, p: 8, c: 48, f: 16 },
  { name: "Tepsi Böreği (Peynirli)", ref: 1, unit: "porsiyon", cal: 370, p: 12, c: 40, f: 18 },
  { name: "Sarıyer Böreği (Kıymalı)", ref: 1, unit: "porsiyon", cal: 478, p: 16, c: 45, f: 26 },
  { name: "Sarıyer Böreği (Peynirli)", ref: 1, unit: "porsiyon", cal: 452, p: 14, c: 45, f: 24 },
  { name: "Gül Böreği (Patatesli)", ref: 1, unit: "adet", cal: 386, p: 8, c: 48, f: 18 },
  { name: "Gül Böreği (Ispanaklı)", ref: 1, unit: "adet", cal: 289, p: 8, c: 35, f: 13 },
  { name: "Gül Böreği (Kıymalı)", ref: 1, unit: "adet", cal: 337, p: 11, c: 35, f: 17 },
  { name: "Gül Böreği (Peynirli)", ref: 1, unit: "adet", cal: 315, p: 10, c: 35, f: 15 },
  { name: "Sigara Böreği (Kızartma)", ref: 4, unit: "adet", cal: 295, p: 10, c: 30, f: 15 },
  { name: "Sigara Böreği (Fırında / Az Yağlı)", ref: 4, unit: "adet", cal: 212, p: 8, c: 28, f: 7.5 },
  { name: "Paçanga Böreği", ref: 1, unit: "adet", cal: 310, p: 12, c: 25, f: 18 },
  { name: "Çiğ Börek / Şırbörek", ref: 1, unit: "adet", cal: 296, p: 10, c: 28, f: 16 },
  { name: "Talaş Böreği", ref: 1, unit: "adet", cal: 418, p: 15, c: 40, f: 22 },
  { name: "Milföy Börek (Peynirli)", ref: 2, unit: "adet", cal: 370, p: 8, c: 35, f: 22 },
  ...
  { name: "Etliekmek (Konya)", ref: 1, unit: "porsiyon", cal: 470, p: 22, c: 55, f: 18 },
  ...
  { name: "Anne Poğaçası (Ev Tipi)", ref: 1, unit: "adet", cal: 216, p: 5, c: 22, f: 12 },
  ...
  { name: "Kaşarlı Açma", ref: 1, unit: "adet", cal: 376, p: 9, c: 40, f: 20 },
  { name: "Boyoz", ref: 1, unit: "adet", cal: 264, p: 5, c: 25, f: 16 },
  { name: "Ay Çöreği", ref: 1, unit: "adet", cal: 374, p: 8, c: 45, f: 18 },
  { name: "Tahinli Çörek", ref: 1, unit: "adet", cal: 428, p: 8, c: 45, f: 24 },
  { name: "İzmir Bomba", ref: 1, unit: "adet", cal: 186, p: 4, c: 20, f: 10 },

  // --- Kullanıcı Güncellemesi: Peynir Çeşitleri ---
  { name: "Tam Yağlı Beyaz Peynir", ref: 30, unit: "g", cal: 90, p: 4.5, c: 1, f: 7.5 },
  ...
  { name: "Lor Peyniri (Yağsız)", ref: 50, unit: "g", cal: 45, p: 8, c: 1.5, f: 0.8 },
  ...
  { name: "Burgu Peynir", ref: 30, unit: "g", cal: 87, p: 6, c: 1, f: 6.6 },

  // --- Kullanıcı Güncellemesi: Kahvaltılıklar & Şarküteri ---
  { name: "Siyah Zeytin", ref: 10, unit: "adet", cal: 45, p: 0.5, c: 1, f: 4.3 },
  { name: "Yeşil Zeytin", ref: 10, unit: "adet", cal: 49, p: 0.5, c: 1.5, f: 4.5 },
  { name: "Çizik/Kırma Zeytin", ref: 10, unit: "adet", cal: 49, p: 0.5, c: 1.5, f: 4.5 },
  { name: "Acuka / Cevizli Ezme", ref: 15, unit: "g", cal: 67, p: 1, c: 3, f: 5.7 },
  { name: "Tereyağı", ref: 10, unit: "g", cal: 75, p: 0, c: 0, f: 8.3 },
  ...
  { name: "Nutella / Sürülebilir Çiko", ref: 15, unit: "g", cal: 81, p: 1, c: 9, f: 4.5 },
  { name: "Şekersiz Fıstık Ezmesi", ref: 15, unit: "g", cal: 96, p: 4, c: 3, f: 7.5 },
  { name: "Tahin", ref: 15, unit: "g", cal: 89, p: 2.5, c: 3, f: 7.4 },
  { name: "Pekmez", ref: 15, unit: "g", cal: 44, p: 0, c: 11, f: 0 },
  { name: "Hindi Füme", ref: 3, unit: "dilim", cal: 33, p: 6, c: 1, f: 0.5 },
  { name: "Tavuk Jambon", ref: 30, unit: "g", cal: 39, p: 5, c: 1, f: 1.7 },
  { name: "Dana Salam (Macar/Fıstıklı)", ref: 50, unit: "g", cal: 122, p: 6, c: 2, f: 10 },
  { name: "Dana Sosis", ref: 50, unit: "g", cal: 140, p: 6, c: 2, f: 12 },
  { name: "Dana Sucuk (Çiğ/Izgara)", ref: 50, unit: "g", cal: 164, p: 7, c: 1, f: 14.7 },
  { name: "Piliç Sucuk", ref: 50, unit: "g", cal: 124, p: 6.5, c: 2, f: 10 },
  { name: "Çemensiz Pastırma", ref: 30, unit: "g", cal: 79, p: 9, c: 0, f: 4.8 },
  ...
  { name: "Sade Omlet (Az Yağlı)", ref: 1, unit: "porsiyon", cal: 103, p: 6, c: 0.5, f: 8.6 },
  { name: "Kaşarlı Omlet", ref: 1, unit: "porsiyon", cal: 288, p: 20, c: 1.5, f: 22.4 },
  { name: "Lorlu Omlet", ref: 1, unit: "porsiyon", cal: 214, p: 20, c: 2.5, f: 13.8 },
  ...
  { name: "Patates Kızartması (Fast Food)", ref: 1, unit: "porsiyon", cal: 423, p: 4, c: 50, f: 23 },
  { name: "Fırın Baharatlı Elma Dilim Patates", ref: 1, unit: "porsiyon", cal: 197, p: 3, c: 35, f: 5 },
  { name: "Patates Püresi (Sütlü/Tereyağlı)", ref: 1, unit: "porsiyon", cal: 186, p: 3.5, c: 22, f: 9.3 },
  { name: "Kumpir İçi (Sade)", ref: 1, unit: "porsiyon", cal: 295, p: 5, c: 35, f: 15 },
  { name: "Çıtır Hash Browns", ref: 2, unit: "adet", cal: 265, p: 2, c: 26, f: 17 },
  { name: "Airfryer Patates (Az Yağlı)", ref: 1, unit: "porsiyon", cal: 154, p: 3, c: 32, f: 1.6 },

  // --- Kullanıcı Güncellemesi: Kuruyemişler (30g Porsiyon Ortalama) ---
  { name: "Ceviz İçi", ref: 30, unit: "g", cal: 210, p: 4.5, c: 4, f: 19.5 },
  ...
  { name: "Antep Fıstığı", ref: 30, unit: "g", cal: 178, p: 6, c: 8, f: 13.5 },
  { name: "Ay Çekirdeği (İç)", ref: 30, unit: "g", cal: 188, p: 6, c: 6, f: 15.5 },
  { name: "Kabak Çekirdeği (İç)", ref: 30, unit: "g", cal: 178, p: 9, c: 4, f: 14 },
  { name: "Sarı Leblebi", ref: 30, unit: "g", cal: 106, p: 6, c: 17, f: 1.5 },
  { name: "Beyaz Leblebi", ref: 30, unit: "g", cal: 103, p: 5.5, c: 18, f: 1 },

  // --- Kullanıcı Güncellemesi: Meyveler ve Kuru Meyveler ---
  { name: "Muz (Orta Boy)", ref: 100, unit: "g", cal: 99, p: 1, c: 23, f: 0.3 },
  { name: "Karpuz", ref: 100, unit: "g", cal: 36, p: 0.6, c: 8, f: 0.2 },
  { name: "Kuru Üzüm", ref: 30, unit: "g", cal: 101, p: 1, c: 24, f: 0.1 },
  { name: "Kuru Kayısı", ref: 30, unit: "g", cal: 81, p: 1, c: 19, f: 0.1 },
  { name: "Kuru İncir", ref: 30, unit: "g", cal: 83, p: 1, c: 19, f: 0.3 },
  { name: "Hurma", ref: 30, unit: "g", cal: 92, p: 0.7, c: 22, f: 0.1 },

  // --- Kullanıcı Güncellemesi: Soslar (Genellikle 1 Yemek Kaşığı / 15g Bazlıdır) ---
  { name: "Ketçap", ref: 15, unit: "g", cal: 17, p: 0.2, c: 4, f: 0 },
  { name: "Mayonez (Tam Yağlı)", ref: 15, unit: "g", cal: 101, p: 0.1, c: 0.5, f: 11 },
  { name: "Hardal", ref: 15, unit: "g", cal: 10, p: 0.6, c: 0.8, f: 0.5 },
  { name: "Ranch Sos", ref: 15, unit: "g", cal: 68, p: 0.2, c: 1, f: 7 },
  { name: "Barbekü (BBQ) Sos", ref: 15, unit: "g", cal: 26, p: 0.2, c: 6, f: 0.1 },
  { name: "Acı Sos (Hot Sauce)", ref: 15, unit: "g", cal: 3, p: 0.1, c: 0.6, f: 0 },
  { name: "Nar Ekşisi (Orijinal)", ref: 15, unit: "g", cal: 37, p: 0.2, c: 9, f: 0 },
  { name: "Soya Sosu", ref: 15, unit: "g", cal: 9, p: 1.2, c: 1, f: 0 },

  // --- Kullanıcı Güncellemesi: Sporcu Takviyeleri ---
  { name: "Whey Protein Tozu", ref: 30, unit: "g", cal: 118, p: 24, c: 2, f: 1.5 },
  { name: "Casein Protein", ref: 30, unit: "g", cal: 109, p: 23, c: 3, f: 0.5 },
  ...
  { name: "Mücver (Kızartma)", ref: 2, unit: "dilim", cal: 256, p: 8, c: 20, f: 16 },
  ...
  { name: "Bisküvili Çikolata Bar (Standart)", ref: 40, unit: "g", cal: 202, p: 3, c: 25, f: 10 },
  ...
  { name: "Fıstıklı Kutu Dondurma", ref: 100, unit: "g", cal: 234, p: 5, c: 22, f: 14 },
  ...
  { name: "Mantarlı İsviçre Burger", ref: 1, unit: "adet", cal: 544, p: 28, c: 45, f: 28 },
  ...
  { name: "Zurna Et Dürüm", ref: 1, unit: "adet", cal: 765, p: 42, c: 75, f: 33 },
  { name: "Tavuk Döner (Yarım Ekmek Arası)", ref: 1, unit: "adet", cal: 486, p: 26, c: 55, f: 18 },
  { name: "Et Döner (Yarım Ekmek Arası)", ref: 1, unit: "adet", cal: 564, p: 32, c: 55, f: 24 },
  { name: "Tombik Tavuk Döner (Pide Arası)", ref: 1, unit: "adet", cal: 448, p: 24, c: 52, f: 16 },
  { name: "Kaşarlı Tavuk Dürüm (Dürümx Tarzı)", ref: 1, unit: "adet", cal: 582, p: 32, c: 55, f: 26 },
  ...
  { name: "Çift Kaşarlı Tost (Bol Malzemeli)", ref: 1, unit: "adet", cal: 390, p: 18, c: 30, f: 22 },
  ...
  { name: "Kavurmalı Kaşarlı Tost", ref: 1, unit: "adet", cal: 450, p: 22, c: 32, f: 26 },
  { name: "Salçalı Sosisli Tost", ref: 1, unit: "adet", cal: 358, p: 14, c: 35, f: 18 },
  { name: "Kumru (Çeşme Usulü)", ref: 1, unit: "adet", cal: 646, p: 25, c: 60, f: 34 },
  ...
  { name: "Kaşarlı Patso (Yarım Ekmek)", ref: 1, unit: "adet", cal: 636, p: 16, c: 80, f: 28 },
  { name: "Sosisli Patso (Yarım Ekmek)", ref: 1, unit: "adet", cal: 672, p: 14, c: 82, f: 32 },
  { name: "Karışık Patso (Kaşar+Sosis+Patates)", ref: 1, unit: "adet", cal: 776, p: 22, c: 82, f: 40 },
  { name: "Köfte Ekmek (Yarım Ekmek)", ref: 1, unit: "adet", cal: 556, p: 25, c: 60, f: 24 },
  { name: "Sucuk Ekmek (Yarım Ekmek Izgara)", ref: 1, unit: "adet", cal: 616, p: 22, c: 60, f: 32 },
  ...
  { name: "Balık Ekmek (Yarım Ekmek)", ref: 1, unit: "adet", cal: 460, p: 24, c: 55, f: 16 },
  { name: "Arnavut Ciğeri (Yarım Ekmek Arası)", ref: 1, unit: "adet", cal: 597, p: 28, c: 65, f: 25 },

  // --- Yeni Eklemeler: Ev Yemekleri, Fast Food, Hamur İşleri, Tatlılar ve İçecekler ---
  { name: "Sucuklu Kuru Fasulye", ref: 1, unit: "porsiyon", cal: 363, p: 18, c: 30, f: 19 },
  { name: "Kıymalı Bezelye Yemeği", ref: 1, unit: "porsiyon", cal: 234, p: 14, c: 22, f: 10 },
  { name: "Kıymalı Patates Yemeği", ref: 1, unit: "porsiyon", cal: 268, p: 12, c: 28, f: 12 },
  { name: "Kıymalı Taze Fasulye", ref: 1, unit: "porsiyon", cal: 182, p: 10, c: 14, f: 9.5 },
  { name: "Zeytinyağlı Biber Dolması", ref: 1, unit: "adet", cal: 172, p: 2.5, c: 28, f: 5.5 },
  { name: "Etli Lahana Sarması", ref: 4, unit: "adet", cal: 218, p: 12, c: 20, f: 10 },
  { name: "Zeytinyağlı Lahana Sarması", ref: 4, unit: "adet", cal: 189, p: 2, c: 26, f: 8.5 },
  { name: "Fırın Patates Köfte", ref: 1, unit: "porsiyon", cal: 379, p: 22, c: 30, f: 19 },
  { name: "Patlıcan Musakka", ref: 1, unit: "porsiyon", cal: 290, p: 12, c: 12, f: 21.5 },
  { name: "Kadınbudu Köfte", ref: 2, unit: "adet", cal: 307, p: 16, c: 18, f: 19 },
  { name: "İçli Köfte (Haşlama)", ref: 1, unit: "adet", cal: 163, p: 8, c: 18, f: 6.5 },
  { name: "İçli Köfte (Kızartma)", ref: 1, unit: "adet", cal: 221, p: 8, c: 18, f: 13 },
  { name: "Zeytinyağlı Enginar Yemeği", ref: 1, unit: "adet", cal: 140, p: 3, c: 15, f: 7.5 },
  { name: "Zeytinyağlı Pırasa Yemeği", ref: 1, unit: "porsiyon", cal: 129, p: 2.5, c: 15, f: 6.5 },
  { name: "Zeytinyağlı Bamya Yemeği", ref: 1, unit: "porsiyon", cal: 108, p: 2.5, c: 12, f: 5.5 },
  { name: "Beyti Kebap", ref: 1, unit: "porsiyon", cal: 775, p: 38, c: 50, f: 47 },
  { name: "Urfa Kebap", ref: 1, unit: "porsiyon", cal: 363, p: 25, c: 5, f: 27 },
  { name: "Ali Nazik Kebabı", ref: 1, unit: "porsiyon", cal: 422, p: 28, c: 10, f: 30 },
  { name: "Çökertme Kebabı", ref: 1, unit: "porsiyon", cal: 677, p: 32, c: 45, f: 41 },
  { name: "Pizza Margherita (Dilim)", ref: 1, unit: "dilim", cal: 188, p: 8, c: 22, f: 7.5 },
  { name: "Pepperoni / Sucuklu Pizza (Dilim)", ref: 1, unit: "dilim", cal: 240, p: 10, c: 23, f: 12 },
  { name: "Klasik Burger (Fast Food)", ref: 1, unit: "adet", cal: 300, p: 15, c: 33, f: 12 },
  { name: "Cheeseburger (Fast Food)", ref: 1, unit: "adet", cal: 339, p: 17, c: 34, f: 15 },
  { name: "Tavuk Burger (Fast Food)", ref: 1, unit: "adet", cal: 358, p: 16, c: 42, f: 14 },
  { name: "Patatesli Gözleme", ref: 1, unit: "adet", cal: 449, p: 9, c: 65, f: 17 },
  { name: "Kıymalı Gözleme", ref: 1, unit: "adet", cal: 489, p: 16, c: 50, f: 25 },
  { name: "Ispanaklı Gözleme", ref: 1, unit: "adet", cal: 406, p: 11, c: 50, f: 18 },
  { name: "Pişi (Sade)", ref: 1, unit: "adet", cal: 163, p: 3, c: 22, f: 7 },
  { name: "Sade Krep", ref: 1, unit: "adet", cal: 94, p: 3.5, c: 11, f: 4 },
  { name: "Sade Pankek", ref: 1, unit: "adet", cal: 79, p: 2, c: 12, f: 2.5 },
  { name: "Kuymak / Mıhlama", ref: 1, unit: "porsiyon", cal: 487, p: 15, c: 10, f: 43 },
  { name: "Cılbır", ref: 1, unit: "porsiyon", cal: 260, p: 16, c: 4, f: 20 },
  { name: "Muzlu Magnolia", ref: 1, unit: "porsiyon", cal: 312, p: 5, c: 46, f: 12 },
  { name: "Çilekli Magnolia", ref: 1, unit: "porsiyon", cal: 295, p: 5, c: 44, f: 11 },
  { name: "San Sebastian Cheesecake", ref: 1, unit: "porsiyon", cal: 486, p: 8, c: 28, f: 38 },
  { name: "Waffle (Meyveli & Çikolatalı)", ref: 1, unit: "adet", cal: 585, p: 10, c: 80, f: 25 },
  { name: "Çikolatalı Sufle", ref: 1, unit: "adet", cal: 346, p: 6, c: 40, f: 18 },
  { name: "Mozaik Pasta", ref: 1, unit: "dilim", cal: 275, p: 4.5, c: 35, f: 13 },
  { name: "Kemalpaşa Tatlısı", ref: 3, unit: "adet", cal: 219, p: 3, c: 45, f: 3 },
  { name: "Şekerpare", ref: 2, unit: "adet", cal: 282, p: 4, c: 45, f: 9.5 },
  { name: "Revani", ref: 1, unit: "dilim", cal: 318, p: 5, c: 52, f: 10 },
  { name: "İrmik Helvası", ref: 1, unit: "porsiyon", cal: 356, p: 4, c: 58, f: 12 },
  { name: "Tulumba Tatlısı", ref: 4, unit: "adet", cal: 208, p: 2, c: 32, f: 8 },
  { name: "Soslu Mısır (Kuru)", ref: 30, unit: "g", cal: 131, p: 2.5, c: 20, f: 4.5 },
  { name: "Patlamış Mısır (Yağlı, Tuzlu)", ref: 1, unit: "bardak", cal: 45, p: 0.8, c: 6, f: 2 },
  { name: "Sıcak Salep", ref: 1, unit: "fincan", cal: 176, p: 4, c: 32, f: 3.5 },
  { name: "Boza", ref: 1, unit: "bardak", cal: 232, p: 3.5, c: 50, f: 2 },
  { name: "Sıkma Portakal Suyu", ref: 1, unit: "bardak", cal: 91, p: 1.4, c: 21, f: 0.2 },
  { name: "Sıkma Nar Suyu", ref: 1, unit: "bardak", cal: 111, p: 1.2, c: 26, f: 0.2 }
];
